...
void ParentRoutine(FILE* fin)
{
    ...
    const char* semChildFile1 = "semaphoreChild1";
    const char* semChildFile2 = "semaphoreChild2";

	sem_t* sem1 = sem_open(semFile1, O_CREAT, S_IRUSR | S_IWUSR, 0);
	sem_t* sem2 = sem_open(semFile2, O_CREAT, S_IRUSR | S_IWUSR, 0);

    sem_t* semChild1 = sem_open(semChildFile1, O_CREAT, S_IRUSR | S_IWUSR, 0);
    sem_t* semChild2 = sem_open(semChildFile2, O_CREAT, S_IRUSR | S_IWUSR, 0);

    if (semChild1 == SEM_FAILED || semChild2 == SEM_FAILED)
    {
        exit(EXIT_FAILURE);
    }
    ...
    if (pid1 == 0) 
    {
        ...
        sem_t* semChild = sem_open(semChildFile1, 0);
    ...
    else if (pid2 == 0)
    {
        ...
        sem_t* semChild = sem_open(semChildFile2, 0);
    ...
    else 
    {
        ...
        sem_t* semChild1 = sem_open(semChildFile1, 0);
        sem_t* semChild2 = sem_open(semChildFile2, 0);
    ...
    sem_unlink(semChildFile1);
    sem_unlink(semChildFile2);
}